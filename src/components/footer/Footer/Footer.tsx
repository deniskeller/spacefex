...
const Links: Links[] = [
  {
    ...
    list: [
      ...
      { name: 'Financial statements', href: '/contacts' },
    ],
  },
  {
    title: 'Help',
    list: [
      { name: 'General help', href: '/system-status' },
      { name: 'System status', href: '/system-status' },
      { name: 'Community', href: '/system-status' },
      { name: 'Developers API', href: '/system-status' },
      { name: 'Reader User Guide', href: '/system-status' },
    ],
  },
  {
    title: 'Website rules',
