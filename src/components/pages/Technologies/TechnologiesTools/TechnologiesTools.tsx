                ...
                >
                  <div className={styles.TechnologiesTools_Item_Description}>
                    <p>
                      ...
                      the financial world, economy and space science. The unique
                      combination of technologies and economics allows us to
                      build a new world for future generations.
                    </p>
                  </div>
                </AnimationOnScroll>
              </li>
                ...
                >
                  <div className={styles.TechnologiesTools_Item_Description}>
                    <p>
                      ...
                      the NASA and receive the allowance from launching our
                      first satellites with all required permissions under their
                      supervision.
                    </p>
                  </div>
                </AnimationOnScroll>
                ...
                >
                  <div className={styles.TechnologiesTools_Item_Description}>
                    <p>
                      ...
                      community would support. The main point is that it would
                      be only the interface to interact with the space
                      infrastructure because all the data and transactions would
                      be performed out of space.
                    </p>
                  </div>
                </AnimationOnScroll>
              </li>
                ...
                >
                  <div className={styles.TechnologiesTools_Item_Description}>
                    <p>
                      ...
                      covers the global earth orbit to communicate with the
                      earth services and process the transactions. The satellite
                      network is entirely independent and secure as it gets the
                      energy from the sun on its batteries and allows to secure
                      the constant payment flow.
                    </p>
                  </div>
                </AnimationOnScroll>
              </li>
